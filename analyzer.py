...
class AdvancedInfluencerAnalyzer:
    def __init__(self):
        self.positive_keywords = [
            ...
            'sucesso', 'conquista', 'vitória', 'prêmio', 'reconhecimento', 'liderança',
            'inovação', 'inspiração', 'motivação', 'crescimento', 'desenvolvimento',
            
            # Palavras relacionadas a valores familiares e sociais
            'família', 'amor', 'felicidade', 'união', 'harmonia', 'paz',
            'solidariedade', 'generosidade', 'bondade', 'compaixão',
            
            # Palavras relacionadas a responsabilidade social
            'caridade', 'educação', 'ensino', 'aprendizado', 'conhecimento',
            'ajuda', 'apoio', 'suporte', 'colaboração', 'parceria',
            
            # Palavras relacionadas a ética e transparência
            'ética', 'transparência', 'honestidade', 'integridade', 'responsabilidade',
            'confiança', 'verdade', 'sinceridade', 'autenticidade',
            
            # Palavras relacionadas a impacto positivo
            'transformação', 'mudança positiva', 'impacto social', 'benefício',
            'melhoria', 'progresso', 'evolução', 'avanço'
        ]
        
        self.negative_keywords = [
            # Palavras relacionadas a crimes e problemas legais
            'roubo', 'furto', 'crime', 'prisão', 'preso', 'condenação', 'processo',
            'investigação', 'acusação', 'denúncia', 'fraude', 'golpe', 'estelionato',
            
            # Palavras relacionadas a vícios e comportamentos prejudiciais
            'casino', 'apostas', 'vício', 'drogas', 'entorpecentes', 'álcool',
            'dependência', 'abuso', 'excesso',
            
            # Palavras relacionadas a violência e agressão
            'violência', 'agressão', 'briga', 'conflito', 'discussão', 'confusão',
            'pancadaria', 'luta', 'confronto', 'hostilidade',
            
            # Palavras relacionadas a escândalos e polêmicas
            'escândalo', 'polêmica', 'controversia', 'problema', 'crise',
            'confusão', 'bagunça', 'tumulto', 'alvoroço',
            
            # Palavras relacionadas a corrupção e desonestidade
            'corrupção', 'suborno', 'propina', 'lavagem', 'sonegação',
            'mentira', 'falsidade', 'enganação', 'trapaça',
            
            # Palavras relacionadas a discriminação e preconceito
            'racismo', 'preconceito', 'discriminação', 'intolerância',
